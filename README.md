...
althought it is not compiled with most optional features.  Only IMAP and LMTP are
available, and SSL is disabled.
...
Ports 24 (LMTP) and 143 (IMAP) are exposed by default.
